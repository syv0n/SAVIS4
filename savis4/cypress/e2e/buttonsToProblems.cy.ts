describe('Buttons Link to Practice Problems', () => {
    ...
    it('should go from /barchart to /problems-bar-chart', () => {
        ...
        cy.contains('Bar Chart Practice Problems').click()
    ...
    it('should go from /dotplot to /problems-dot-plot', () => {
        ...
        cy.contains('Dot Plot Practice Problems').click()
    ...
    it('should go from /oneproportion to /problems-opht', () => {
        ...
        cy.contains('One Proportion Hypothesis Testing Practice Problems').click()
    ...
    it('should go from /twoproportions to /problems-tpht', () => {
        ...
        cy.contains('Two Proportion Hypothesis Testing Practice Problems').click()
    ...
    it('should go from /onemean to /problems-omht', () => {
        ...
        cy.contains('One Mean Hypothesis Testing Practice Problems').click()
    ...
    it('should go from /twomeans to problems-tmht', () => {
        ...
        cy.contains('Two Mean Hypothesis Testing Practice Problems').click()
    ...
    it('should go from /LR to problems-regression', () => {
        ...
        cy.contains('Linear Regression Practice Problems').click()
    ...
    it('should go from /correlation to problems-correlation', () => {
        ...
        cy.contains('Correlation Practice Problems').click()
    ...
    it('should go from /oneproportionCI to problems-opci', () => {
        ...
        cy.contains('One Proportion Confidence Interval Practice Problems').click()
    ...
    it('should go from /twoproportionsCI to problems-tpci', () => {
        ...
        cy.contains('Two Proportion Confidence Interval Practice Problems').click()
    ...
    it('should go from /onemeanCI to problems-omci', () => {
        ...
        cy.contains('One Mean Confidence Interval Practice Problems').click()
    ...
    it('should go from /twomeansCI to problems-tmci', () => {
        ...
        cy.contains('Two Mean Confidence Interval Practice Problems').click()
