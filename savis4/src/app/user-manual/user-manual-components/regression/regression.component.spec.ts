...
describe('RegressionManualComponent', () => {
  let component: RegressionManualComponent;
  let fixture: ComponentFixture<RegressionManualComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ RegressionManualComponent, NavbarComponent, FooterComponent, LanguageSwitcherComponent, CalculatorComponent ],
      imports: [ 
